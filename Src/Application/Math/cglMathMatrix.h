  ...
  public:
    ...
    TMatrix operator*( const TMatrix &matr ) const
    {
      ...
      ResMatr.M[3][1] = M[3][0] * matr.M[0][1] + M[3][1] * matr.M[1][1] +
                        M[3][2] * matr.M[2][1] + M[3][2] * matr.M[3][1];
      ...
      ResMatr.M[0][3] = M[0][0] * matr.M[0][3] + M[0][1] * matr.M[1][3] +
                        M[0][2] * matr.M[2][3] + M[0][3] * matr.M[3][3];
      ResMatr.M[1][3] = M[1][0] * matr.M[0][3] + M[1][1] * matr.M[1][3] +
                        M[1][2] * matr.M[2][3] + M[1][3] * matr.M[3][3];
      ResMatr.M[2][3] = M[2][0] * matr.M[0][3] + M[2][1] * matr.M[1][3] +
                        M[2][2] * matr.M[2][3] + M[2][3] * matr.M[3][3];
      ResMatr.M[3][3] = M[3][0] * matr.M[0][3] + M[3][1] * matr.M[1][3] +
